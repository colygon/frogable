            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 ">Configure your Frogable preferences</p>
                </div>
              </div>
              <button
                onClick={onClose}
            ...
            {activeTab === 'about' && (
              <div className="space-y-6">
                <div className="text-center">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 ">Frogable</h3>
                ...
                <div className="bg-gray-50 rounded-xl border border-gray-200 p-6 space-y-4">
                  <div className="text-center">
                    <p className="text-base text-gray-700 leading-relaxed max-w-2xl mx-auto">
                      Frogable is an AI-powered development platform that integrates with GitHub, Supabase, and Vercel 
                ...
                <div className="text-center">
                  <div className="flex justify-center gap-6">
                    <a 
                      href="https://github.com/opactorai/Frogable" 
                      target="_blank"
